...
The system SHALL provide controls to navigate to the previous week, the next week, and back to the current week, updating the displayed week and its data accordingly.
...
- **THEN** the system displays the Monday-start week containing the current date
